...
type UseDashboardLayoutResult = {
  ...
  cancel: () => void
  cancelModal: React.ReactElement
  currentLayout: WidgetInstanceClient[]
  deleteWidget: (widgetId: string) => void
  isEditing: boolean
  moveWidget: (args: { moveFromIndex: number; moveToIndex: number }) => void
...
export function useDashboardLayout(initialLayout: WidgetInstanceClient[]): UseDashboardLayoutResult {
