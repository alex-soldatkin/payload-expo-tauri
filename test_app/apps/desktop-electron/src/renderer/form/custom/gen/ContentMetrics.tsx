...
// Verbatim copy of components/ContentMetrics/index.tsx ('use client' stripped);
...
export const ContentMetrics: React.FC<{ path: string }> = ({ path }) => {
  ...
  return (
    <div className="content-metrics" style={{ marginTop: 8, marginBottom: 8 }}>
      ...
      {/* Warnings */}
      {!metrics.titleOk && (
        <p style={{ fontSize: 12, color: '#ca8a04', margin: 0, marginBottom: 4 }}>
