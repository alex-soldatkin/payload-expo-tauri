/**
 * VisibilitySection — SEPARATE non-drag section (see CalendarCustomizeSheet
 * docblock): native SwiftUI Toggle switches are safe here, OUTSIDE the
 * Sortable tree. ON = source visible on the calendar (sets `hidden` in the
 * draft; the header legend seeds from it after save). lucide Eye/EyeOff
