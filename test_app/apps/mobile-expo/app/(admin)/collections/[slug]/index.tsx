...
import { Bookmark, CalendarDays, ChartGantt, Check, CheckSquare, Filter, Plus, QrCode, Settings, SquareKanban, Table2 } from 'lucide-react-native'
      ...
      {isKanban && kanbanStatusField ? (
        ...
        (<View style={{ flex: 1, paddingTop: headerHeight }}>
          ...
          <GanttHeaderRow
            ...
            onToday={() => ganttRef.current?.scrollToToday(true)}
            onToggleSource={handleGanttToggleSource}
          />
          <GanttChart
            ref={ganttRef}
            docs={boardDocs}
            ...
            onPxPerDayChange={handleGanttPxPerDayChange}
          />
        </View>)
      ) : (
        <DocumentList
